...
\begin{myremark}[о методе «устранения перегородок» в алгоритме~\ref{algo-del-eps}, с.~\pageref{algo-del-eps}]
...
\begin{myremark}[о введении новых нетерминалов в алгоритме~\ref{to-cnf}, с.~\pageref{to-cnf}]
